...
| [Определение наиболее выгодного региона нефтедобычи](Outflow_of_bank_customers) | На основе данных геологи разведки выбрать район добычи нефти. | *pandas*, *matplotlib*, *seaborn*, *scikit-learn*, *numpy*. |
